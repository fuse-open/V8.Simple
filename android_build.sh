...
export LDFLAGS=" -L$SYSROOT_DIR/usr/lib -Ldeps/libs/android $COMMON_FLAGS -Wl,--whole-archive -lv8_base -lv8_libbase -lv8_libplatform -lv8_libsampler -lv8_nosnapshot -L$STDLIB_LIB_DIR -landroid_support -lunwind -l$STDLIB -l$STDLIBABI -Wl,--no-whole-archive -Wl,--gc-sections -Wl,-soname,libV8Simple.so"
