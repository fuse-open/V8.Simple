...
export LDFLAGS=" -L$HOME/v8-lib/lib-android $COMMON_FLAGS -fdata-sections -ffunction-sections -Wl,--whole-archive $STLPORT_DIR/libs/armeabi-v7a/libstlport_static.a -lv8_base -lv8_libbase -lv8_libplatform -lv8_nosnapshot -Wl,--no-whole-archive -Wl,--gc-sections -Wl,--strip-all"
