...
export LDFLAGS=" -Ldeps/libs/android $COMMON_FLAGS -fdata-sections -ffunction-sections -Wl,--whole-archive $STLPORT_DIR/libs/armeabi-v7a/libstlport_static.a -lv8_base -lv8_libbase -lv8_libplatform -lv8_nosnapshot -Wl,--no-whole-archive -Wl,--gc-sections -Wl,--strip-all -Wl,-soname,libV8Simple.so"
export CXXFLAGS=" -Os -Ideps $COMMON_FLAGS -fvisibility=hidden -fvisibility-inlines-hidden -DBUILDING_DLL"
